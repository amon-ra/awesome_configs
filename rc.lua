...
vicious.register(tdwidget_text, vicious.widgets.date, '<span font="Xifiction 10"> %b %d %H:%M </span>', 20)
...
vicious.register(volume_text, vicious.widgets.volume, '<span font="Xifiction 10"> $1% </span>', 1, "Master")
